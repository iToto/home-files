...
function registerCommands(context, platformContext, auditContext, secrets, store, favorites, importedUrls, cache, provider, tree, reportWebView, tagsWebView, signUpWebView, dataDictionaryView, dataDictionaryDiagnostics) {
    const commands = {};
