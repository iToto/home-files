          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            ...
            <div className="relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-32">
              ...
              <p className="mx-auto mt-6 max-w-lg text-center text-xl text-green sm:max-w-3xl">
                We are a small team of web developers and IT professionals based in North America. We specialise in bespoke web development and IT services for small businesses and individuals.
              </p>
