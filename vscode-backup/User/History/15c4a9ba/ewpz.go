...
func main() {
	...
	router.HandleFunc("/", Index, wl)
	router.HandleFunc("/foo", FooIndex, wl)
	log.Fatal(http.ListenAndServe(":"+port, router))
}

func Index(w http.ResponseWriter, r *http.Request, wl wlog.Logger) {
	fmt.Fprintln(w, "Hello there and welcome to your service!")
}

func FooIndex(w http.ResponseWriter, r *http.Request, wl wlog.Logger) {
