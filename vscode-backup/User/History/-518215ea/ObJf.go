// Package ycontext will contain all context keys shared within the yield applications.
package ycontext
...
const (
	...
	// ContextKeyChain holds the context key for a crypto chain (BTC/ETH)
	ContextKeyChain ContextKey = "chain"
)
...
// WithChain creates a new context with the passed crypto chain
