...
func (ss *signalService) calculateMarginSide(
	...
	// wl.Debugf("balance: %f, unrealizedPnl: %f, entryPrice: %f", balance, position.UnrealizedPnl, position.EntryPrice)
	// (0.483861 - 0.02138496) * (4/3) * 1721.620 = 1,061.7794083613
	...
	wl.Debugf("posA: %f, neutralLowerBound: %f, neutralUpperBound: %f", posA, neutralLowerBound, neutralUpperBound)
