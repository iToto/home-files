...
func TestCreateFundingAccount(t *testing.T) {
	...
	tt := []struct {
		...
		},
		{
			...
			expectedErr: errors.New("tabapayclient: duplicate found error: unexpected end of JSON input"),
		},
		{
			...
			expectedErr: errors.New("tabapayclient: expected 1 duplicate account to be found got 2 duplicates"),
		},
		{
