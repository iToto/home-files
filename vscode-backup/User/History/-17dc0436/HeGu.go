...
type Config struct {
	GCPprojectID string `env:"TRADELOGGER_GCP_PROJECT_ID"`
	DataSet      string `env:"TRADELOGGER_DATASET"`
	Table        string `env:"TRADELOGGER_TABLE"`
	// only used for local development
	ServiceAccountFile string `env:"TRADELOGGER_SERVICE_ACCOUNT_FILE"`
}
