...
type record struct {
	...
	Chain        string    `bigquery:"chain" json:"chain"`
	Strategy     string    `bigquery:"strategy" json:"strategy"`
	SignalID     string    `bigquery:"signal_id" json:"signal_id"`
	TradeOrderID string    `bigquery:"trade_order_id" json:"trade_order_id"` //CoinRoutes: ClientOrderID
	Quantity     string    `bigquery:"quantity" json:"quantity"`
	Side         string    `bigquery:"side" json:"side"`
	CurrencyPair string    `bigquery:"currency_pair" json:"currency_pair"`
