...
func main() {
	...
	// setup exchange clients
	// load strategy credentials
	var okxStrategies []okxapi.StrategyCredentials

	ztradebtcv2 := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_ONE_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_ONE_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_ONE_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_ONE_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ztradebtcv2)

	new705_COIN := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_ONE_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_ONE_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_ONE_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_ONE_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, new705_COIN)

	ztradebtcv2_COIN := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_TWO_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_TWO_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_TWO_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_TWO_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ztradebtcv2_COIN)

	ytradeliqbtc18long_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_THREE_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_THREE_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_THREE_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_THREE_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ytradeliqbtc18long_USD)

	ztradebtcmicmaclong_COIN := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_FOUR_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_FOUR_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_FOUR_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_FOUR_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ztradebtcmicmaclong_COIN)

	feb24btcmicmac_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_FIVE_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_FIVE_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_FIVE_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_FIVE_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, feb24btcmicmac_USD)

	longtermdec13_COIN := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_SIX_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_SIX_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_SIX_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_SIX_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, longtermdec13_COIN)

	ytradeliqeth18long_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_SEVEN_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_SEVEN_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_SEVEN_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_SEVEN_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ytradeliqeth18long_USD)

	ytradeliqethsoprlong_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_EIGHT_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_EIGHT_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_EIGHT_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_EIGHT_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ytradeliqethsoprlong_USD)

	ztradeethmicmacl_COIN := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_NINE_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_NINE_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_NINE_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_NINE_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, ztradeethmicmacl_COIN)

	mlbtcliq18_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_TEN_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_TEN_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_TEN_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_TEN_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, mlbtcliq18_USD)

	mlethliq18_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_ELEVEN_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_ELEVEN_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_ELEVEN_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_ELEVEN_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, mlethliq18_USD)

	// trach708_USD := okxapi.StrategyCredentials{
	// 	Name:       os.Getenv("OKX_STRAT_TWELVE_NAME"),
	// 	APIKey:     os.Getenv("OKX_STRAT_TWELVE_API_KEY"),
	// 	Passphrase: os.Getenv("OKX_STRAT_TWELVE_PASSPHRASE"),
	// 	SecretKey:  os.Getenv("OKX_STRAT_TWELVE_SECRET_KEY"),
	// }
	// okxStrategies = append(okxStrategies, trach708_USD)

	tracklong6h5_USD := okxapi.StrategyCredentials{
		Name:       os.Getenv("OKX_STRAT_THIRTEEN_NAME"),
		APIKey:     os.Getenv("OKX_STRAT_THIRTEEN_API_KEY"),
		Passphrase: os.Getenv("OKX_STRAT_THIRTEEN_PASSPHRASE"),
		SecretKey:  os.Getenv("OKX_STRAT_THIRTEEN_SECRET_KEY"),
	}
	okxStrategies = append(okxStrategies, tracklong6h5_USD)

	okxConf := okxapi.Config{
		URL:       "https://www.okx.com",
		Stategies: okxStrategies,
	}
	okxExchangeClient, err := okxapi.New(okxConf, client.NewHTTPClient())
	if err != nil {
		log.Fatal("unable to init okx exchange client: %w", err)
	}
