...
const (
	...
	BTCLongNeutral StrategyType = "btc-simulation"
	BTCLongShort   StrategyType = "btc-ls-test"
	ETHLongNeutral StrategyType = "eth-simulation"
	ETHLongShort   StrategyType = "yttest3"
)

func (t StrategyType) Validate() error {
	switch t {
	case Default, ETHLongNeutral, ETHLongShort, BTCLongNeutral, BTCLongShort:
		return nil
	default:
