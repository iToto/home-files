...
const (
	...
	USDTBTCInversePerpetual CurrencyPairType = "BTC-USDT.IPERP"
...
func (s SideType) IsValid() bool {
	switch s {
	case Buy, Sell, Na, Long, Short, Neu:
		return true
	default:
		return false
	}
...
const (
	...
	ETHLongShort    SupportedStrategy = "yttest3"
	ETHUSDT         SupportedStrategy = "3usdttest"
)

func (t SupportedStrategy) Validate() error {
	switch t {
	case Default, ETHLongNeutral, ETHLongShort, ETHUSDT, BTCLongNeutral, BTCLongShort, BTCFTXLongShort:
		return nil
	default:
