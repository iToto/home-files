...
func (t SupportedStrategy) Validate() error {
	switch t {
	case Default, ETHLongNeutral, ETHUSDT, BTCLongNeutral, BTCLongShort, BTCFTXLongShort, BINANCEUSDMBTCLS, BINANCEUSDMETHLS, BINANCEUSDMBTCLS2X, BINANCEUSDMETHLS2X, FtxEthCompound:
		return nil
	default:
