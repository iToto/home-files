...
type SupportedStrategy string

const (
	ftxUsdmEthLsStrategy       SupportedStrategy = "TODO1"
	ftxUsdmEthCompStrategy     SupportedStrategy = "TODO2"
	ftxUsdmBtcLsStrategy       SupportedStrategy = "TODO3"
	ftxUsdmBtcCompStrategy     SupportedStrategy = "TODO4"
	binanceUsdmEthLsStrategy   SupportedStrategy = "newcobtcusdt"
	binanceUsdmEthLs2XStrategy SupportedStrategy = "newcoethusdt"
	binanceUsdmBtcLsStrategy   SupportedStrategy = "ycbtcusdt"
	binanceUsdmBtcLs2XStrategy SupportedStrategy = "ycethusdt"

	// Default            SupportedStrategy = "default"
	// BTCLongNeutral     SupportedStrategy = "btc-TBD"
	// BTCLongShort       SupportedStrategy = "btclstest"
	// BTCFTXLongShort    SupportedStrategy = "ftxbtctest"
	// ETHLongNeutral     SupportedStrategy = "eth-TBD"
	// ETHUSDT            SupportedStrategy = "3usdttest"
	// BINANCEUSDMBTCLS   SupportedStrategy = "newcobtcusdt"
	// BINANCEUSDMETHLS   SupportedStrategy = "newcoethusdt"
	// BINANCEUSDMBTCLS2X SupportedStrategy = "ycbtcusdt"
	// BINANCEUSDMETHLS2X SupportedStrategy = "ycethusdt"
	// FtxEthCompound     SupportedStrategy = "ftxethcompound2"
)

func (t SupportedStrategy) Validate() error {
	switch t {
	case ftxUsdmEthLsStrategy, ftxUsdmEthCompStrategy, binanceUsdmEthLsStrategy, binanceUsdmEthLs2XStrategy, ftxUsdmBtcLsStrategy, ftxUsdmBtcCompStrategy, binanceUsdmBtcLsStrategy, binanceUsdmBtcLs2XStrategy:
		return nil
	default:
		return fmt.Errorf("invalid strategy type: %s", t)
	}
}
...
type ClientOrderCreateRequest struct {
	...
	Strategy           SupportedStrategy `json:"strategy"`
