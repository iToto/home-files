...
type ClientOrderCreateResponse struct {
	...
	AvgFeePrice                  sql.NullString `json:"avg_fee_price,omitempty"`
	...
	TcaReport                    sql.NullString `json:"tca_report,omitempty"`
	OrderType                    string         `json:"order_type,omitempty"`
	OrderStatus                  string         `json:"order_status,omitempty"`
	Aggression                   string         `json:"aggression,omitempty"`
	MovePercentage               sql.NullString `json:"move_percentage,omitempty"`
	PercentLimitPrice            sql.NullString `json:"percent_limit_price,omitempty"`
	MaxPostSize                  string         `json:"max_post_size,omitempty"`
	IsTwap                       bool           `json:"is_twap,omitempty"`
	EndTime                      sql.NullString `json:"end_time,omitempty"`
	IntervalLength               sql.NullString `json:"interval_length,omitempty"`
	TolerancePct                 sql.NullString `json:"tolerance_pct,omitempty"`
	SweepPct                     string         `json:"sweep_pct,omitempty"`
	RepriceSeconds               sql.NullString `json:"reprice_seconds,omitempty"`
	RepriceRandomizationPct      sql.NullString `json:"reprice_randomization_pct,omitempty"`
