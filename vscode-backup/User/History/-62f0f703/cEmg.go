...
func main() {
	...
	ftxUsdmBtcLsStrategy := entities.Strategy{
		...
		CurrencyPair:     entities.USDBTCPerpetual,
	}
	ftxUsdmEthLsStrategy := entities.Strategy{
		...
		TradeStrategy:    entities.Fixed,
		FixedTradeAmount: 10000.00,
		CurrencyPair:     entities.USDETHPerpetual,
	}
	...
	binanceUsdmBtcLsStrategy := entities.Strategy{
		...
		Leverage:      entities.OneX,
		TradeStrategy: entities.Compound,
		CurrencyPair:  entities.USDTBTCPerpetual,
	}
	binanceUsdmEthLsStrategy := entities.Strategy{
		...
		Leverage:      entities.OneX,
		TradeStrategy: entities.Compound,
		CurrencyPair:  entities.USDTETHPerpetual,
	}
	...
	ethChain := entities.Chain{
		...
		Strategies: []entities.Strategy{
			ftxUsdmEthLsStrategy,
			ftxUsdmEthCompStrategy,
			binanceUsdmEthLsStrategy,
			binanceUsdmEthLs2XStrategy,
		},
	}
	btcChain := entities.Chain{
		Type: entities.BTC,
		Strategies: []entities.Strategy{
			ftxUsdmBtcLsStrategy,
			ftxUsdmBtcCompStrategy,
			binanceUsdmBtcLsStrategy,
			binanceUsdmBtcLs2XStrategy,
		},
	}
