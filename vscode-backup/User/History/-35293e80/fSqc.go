...
func main() {
	...
	emptySources := []entities.SignalSource{}
	signalSources := emptySources
	...
	// 	},
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "classificationx1.xeohive.com/test-api/btc-classification-signal-x1",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.ETH,
		// 	IP:            "classificationx1.xeohive.com/test-api/eth-classification-signal-x1",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "classificationx1.xeohive.com/classify-btc",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.ETH,
		// 	IP:            "classificationx1.xeohive.com/classify-eth",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "api.beta.btc.xeohive.com/test-api/r20-long-v05",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.ETH,
		// 	IP:            "api.beta.eth.xeohive.com/test-api/v2-original",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "api.beta.btc.xeohive.com/test-api/v2-original",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "classificationx1.xeohive.com/test-api/btc-classification-signal-x1-mix",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.ETH,
		// 	IP:            "classificationx1.xeohive.com/test-api/eth-classification-signal-x1-mix",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.BTC,
		// 	IP:            "classificationx1-micro.xeohive.com/classify-btc-micro",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
		...
		// {
		// 	Type:          entities.ETH,
		// 	IP:            "classificationx1-micro.xeohive.com/classify-eth-micro",
		// 	Enabled:       true,
		// 	SignalVersion: entities.V2,
		// 	TLS:           true,
		// 	TimeFormat:    "2006-01-02 15:04:05",
