...
func main() {
	...
	signalSources := []entities.SignalSource{
		{
			Type:          entities.BTC,
			IP:            "https://api.addons.xeohive.com/btc-v2-liquidations",
			Enabled:       true,
		...
		{
			Type:          entities.BTC,
			IP:            "https://api.addons.xeohive.com/btc-r18-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.BTC,
			IP:            "https://api.addons.xeohive.com/btc-mix-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.BTC,
			IP:            "https://api.addons.xeohive.com/btc-classification-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-v2-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-r18-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-sopr-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-mix-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-sopr-mix-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
		...
		{
			Type:          entities.ETH,
			IP:            "https://api.addons.xeohive.com/eth-classification-liquidations",
			Enabled:       true,
			SignalVersion: entities.V2,
			TLS:           true,
			TimeFormat:    "2006-01-02 15:04:05",
