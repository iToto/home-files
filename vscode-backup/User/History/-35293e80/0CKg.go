...
func main() {
	...
	signalSources := []entities.SignalSource{
		...
		https://api.addons.xeohive.com/eth-v2-liquidations
		https://api.addons.xeohive.com/eth-r18-liquidations
		https://api.addons.xeohive.com/eth-sopr-liquidations
		https://api.addons.xeohive.com/eth-mix-liquidations
		https://api.addons.xeohive.com/eth-sopr-mix-liquidations
		https://api.addons.xeohive.com/eth-classification-liquidations
